document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      'cv-skill-industrial': 'Lógica Industrial',
      'cv-skill-control': 'Control de Sistemas',
      ...
      'cv-profile-desc': 'Desarrollador generalista enfocado en aplicaciones web interactivas y simulación. Cuento con una sólida base lógica en automatización eléctrica y más de 4 años de experiencia en desarrollo web y despliegues serverless (Firebase, GCP). Comprometido con la seguridad, el alto rendimiento y la entrega de código de excelente calidad.',
      ...
      'cv-exp-intern-role': 'Técnico de Automatización y Electricidad (Prácticas)',
      'cv-exp-intern-date': '2026 (1 mes)',
      'cv-exp-intern-company': 'Iluminación Mi Casa S.L., Huesca',
      'cv-exp-intern-bullet1': 'Diagnóstico y reparación de lógica de control y sistemas industriales cableados.',
      'cv-exp-intern-bullet2': 'Resolución analítica de fallos lógicos en infraestructuras físicas de automatismos.',
      'cv-exp-intern-bullet3': 'Soporte técnico directo al cliente y mantenimiento correctivo de instalaciones.',
    ...
    en: {
      ...
      'cv-skill-industrial': 'Industrial Logic',
      'cv-skill-control': 'Systems Control',
      ...
      'cv-profile-desc': 'Generalist developer focused on interactive web applications and simulation. I have a solid logical foundation in electrical automation and more than 4 years of experience in web development and serverless deployments (Firebase, GCP). Committed to security, high performance, and delivering high-quality code.',
      ...
      'cv-exp-intern-role': 'Automation &amp; Electrical Technician (Internship)',
      'cv-exp-intern-date': '2026 (1 month)',
      'cv-exp-intern-company': 'Iluminación Mi Casa S.L., Huesca',
      'cv-exp-intern-bullet1': 'Diagnosis and repair of control logic and wired industrial systems.',
      'cv-exp-intern-bullet2': 'Analytical troubleshooting of logical failures in physical automation infrastructures.',
      'cv-exp-intern-bullet3': 'Direct customer technical support and corrective maintenance of installations.',
